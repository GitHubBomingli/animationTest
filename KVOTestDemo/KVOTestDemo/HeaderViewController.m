...
- (void)viewDidLoad {
    ...
    _headerSubImageView.center = _headerView.center;
    [_headerView addSubview:_headerSubImageView];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    _headerSubImageView.center = CGPointMake(_headerView.center.x, _headerView.center.y + contentOffsetY / 2.f) ;
    if (contentOffsetY > 0) {
        _headerSubImageView.center = _headerView.center;
    }
